...
@RoutePage()
class AdvanceWidgetPage extends StatefulWidget {
  const AdvanceWidgetPage({super.key});

  @override
  State<AdvanceWidgetPage> createState() => _AdvanceWidgetPageState();
}

class _AdvanceWidgetPageState extends State<AdvanceWidgetPage>with SingleTickerProviderStateMixin {
